...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.science_swipe_refresh_layout);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.science_recycler_view);
